#ifndef GLSZMFEATURES2DWOMERGE_H_INCLUDED
#define GLSZMFEATURES2DWOMERGE_H_INCLUDED
...
/*!
The class GLSZMFeatures2DWOMerge herites from the class GLSZMFeatures2D, because the feature calculations are the same.
...
class GLSZMFeatures2DWOMerge : public GLSZMFeatures2D<T, R>{
    private:
        ...
        boost::multi_array<double, 2> getGLSZMMatrix( boost::multi_array<T, R> inputMatrix, int depth);
...
*/
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::fill2DGLSZMatrices(boost::multi_array<T, R> inputMatrix, boost::multi_array<double, 2> &GLSZMatrix, int depth){
     T actualElement;
...
template <class T, size_t R>
int GLSZMFeatures2DWOMerge<T, R>::getBiggestZoneNr(boost::multi_array<T, R> inputMatrix){
     T actualElement;
     vector<vector<int> > matrixIndices;
     vector<int> actualIndex;
     maxZoneSize=0;
...
*/
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::getNeighbors(boost::multi_array<T, R> &inputMatrix, T actElement, vector<vector< int> > &matrixIndices){
    vector<int> actIndex;
    vector<int> newIndex;
...
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::getALLXYDirections(int &directionX, int &directionY, int angle){
...
*/
template <class T, size_t R>
boost::multi_array<double, 2> GLSZMFeatures2DWOMerge<T,R>::getGLSZMMatrix( boost::multi_array<T, R> inputMatrix, int depth){
...
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::calculateAllGLSZMFeatures2DWOMerge(GLSZMFeatures2DWOMerge<T,R> &GLSZMFeatures, boost::multi_array<T, R> inputMatrix, vector<T> diffGrey, ConfigFile config){
    ...
    for(int depth = 0; depth < totalDepth; depth++){
        boost::multi_array<double,2> GLSZM=GLSZMFeatures.getGLSZMMatrix(inputMatrix, depth);
  ...
  template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::extractGLSZMData(vector<T> &GLSZMData, GLSZMFeatures2DWOMerge<T, R> GLSZMFeatures){
...
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::writeCSVFileGLSZM2DWOMerge(GLSZMFeatures2DWOMerge<T,R> GLSZMFeat, string outputFolder)
{
    string csvName = outputFolder + "/GLSZMFeatures2Davg.csv";
...
template <class T, size_t R>
void GLSZMFeatures2DWOMerge<T, R>::writeOneFileGLSZM2DWOMerge(GLSZMFeatures2DWOMerge<T, R> GLSZMFeat, string outputFolder) {
...
#endif // GLSZMFEATURES2DWOMERGE_H_INCLUDED
